...
<?php
    ...
    include "./dbconn.php";
    $overlapChk = mysqli_query($conn, "SELECT * FROM EDU_FAMILY WHERE GRP_CD='MRG_EDU' AND (M_NAME='".$_POST['M_NAME']."' AND M_TEL_NO='".$_POST['M_TEL_NO']."') AND (F_NAME='".$_POST['F_NAME']."' AND F_TEL_NO='".$_POST['F_TEL_NO']."')");
    ...
    if ($_POST['EF_NO']<1 && mysqli_num_rows($overlapChk) > 0)
    {
        ...
        $insertsql = "INSERT INTO EDU_FAMILY (GRP_CD,MRG_DT,EDU_DT,PLC_TYPE,MRG_PLACE,M_RELIGION,M_NAME,M_BAPT,M_ORG_NM,M_CONFIRM,M_BIRTH,M_TEL_NO,F_RELIGION,F_NAME,F_BAPT,F_ORG_NM,F_CONFIRM,F_BIRTH,F_TEL_NO,REG_DT,EMAIL)";
